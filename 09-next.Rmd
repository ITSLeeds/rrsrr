...
Rather than go off and learn such additional tools, we encourage you to stick with R. It is preferable to know one language in-depth before branching out to learn other approaches. 
As Grolemund & Wickham (2016) put it,: ‘You will get better faster if you dive deep, rather than spreading yourself thinly over many topics.’ 
...
As you will see by visiting r4ds.had.co.nz, many of these topics, including workflow and modelling, will be of use to those of us working from a road safety research perspective.

A strength of R is its flexibility. 
It can be used as a calculator one minute, a statistical modelling toolbox the next, and then as a web application development framework. 
This is illustrated by major Shiny apps, such as the Propensity to Cycle Tool (try it at www.pct.bike), and tools developed by road safety consultancy Agilysis, described in Section 9.4 below. 
Indeed, within the R ecosystem there are many sub-ecosystems, each of which has excellent free and, particularly, open resources for people who want to learn more about a particular domain. 
If you are involved in the geographic analysis of road crash data, the book Geocomputation with R, by yours truly, and which has already been mentioned in Section 7, is highly recommended (Lovelace et al., 2019). 
If you are looking for methods of analysing trends and forecasting with time series data, @hyndman_forecasting_2018’s book on Forecasting, which is also freely available online, is highly recommended. 
...
Here is not the place to explain how to use RMarkdown (Rmd). 
The framework is explained in detail in a free and open book (Xie et al., 2018). 
...
At Agilysis, we have integrated R into almost everything our analytics team does, pushing for our work to be as robust and reproducible as possible. 
...
Emily Nagler, Data Analyst, [RAC Foundation] (https://www.racfoundation.org/)
...
Grolemund et al. (2016). R for Data Science. (1st edition) O’Reilly Media.

Lovelace et al. (2019). Geocomputation with R. CRC Press.

Xie et al. (2018). R Markdown: The Definitive Guide. (1st edition) Boca Raton: Chapman and Hall/CRC.
