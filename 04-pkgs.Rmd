...
To plot non-spatial data, it works as follows (the command should generate the image shown in Figure \@ref(fig:crashes_2019time)):

```{r crashes_2019time, message=FALSE}
library(ggplot2)
