...
This information can be used as the basis of who-hit-who visualisation, in this case looking at vehicles involved in the most commont type of casualties:

```{r}
table(ac_cas_joined$casualty_type)
ac_cas_joined$cas_simple = NULL
```
